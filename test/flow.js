  ...
  it('should trace step calls', function (done) {
    flow('main')(
      ...
      function step5() {
        ...
        assert.strictEqual(this.history[2].stepName, 'startFlow');
        ...
        assert.strictEqual(this.history[4].stepName, 'startFlow');
        ...
        assert.strictEqual(this.history[6].stepName, 'startFlow');
        ...
        assert.strictEqual(this.history[8].stepName, 'startFlow');
